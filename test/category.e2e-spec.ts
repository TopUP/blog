...
describe('CategoryController (e2e)', () => {
    ...
    it('/category (GET)', () => {
        return request(app.getHttpServer()).get('/category').expect(HttpStatus.OK).expect([]);
    });
    ...
    it('/category/:id (GET)', async () => {
        return request(app.getHttpServer()).get('/category/qwerty').expect(HttpStatus.BAD_REQUEST);
    });
    ...
    it('/category/:id (DELETE)', async () => {
        return request(app.getHttpServer()).delete('/category/qwerty').expect(HttpStatus.UNAUTHORIZED);
    });
